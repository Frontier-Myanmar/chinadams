...
var tooltip = d3.select("body")
    .append("div")
		.attr("class", "remove"+divToAttach+".tooltipblock")
...
//       .call(yAxis.orient("right"));
  ...
  getTooltip = function(d,year,pro) {
    if (flow === "Export") 
      return  "<p>မြန်မာနိုင်ငံမှ <br> <span class='tooltiphighlight'>" 
        + d.key + "</span> သို့<br> <span class='tooltiphighlight'>" 
        + year + "</span> တွင် တင်ပို့သည့် ပို့ကုန်<br><span class='tooltiphighlight'>USD " 
        + valueFormat(pro) + "</span></p>"

    else 
      return  "<p><span class='tooltiphighlight'>" + d.key  +"</span> သို့ <br>" 
        +"မြန်မာနိုင်ငံမှ <span class='tooltiphighlight'>" 
        + year + "</span> <br>တွင် တင်သွင်းသည့် သွင်းကုန်<br><span class='tooltiphighlight'>USD " 
        + valueFormat(pro) + "</span></p>";
